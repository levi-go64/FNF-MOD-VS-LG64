...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Yooo Funky Friday",	"Play This Mod on a Friday... Night.",						'friday_night_play',	 true],
		["Yoo you beat lg64!",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["You Beat The Crew!",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
		["Wow You Did It!",			"Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			false],
